...
public class WebhookPublisher : IWebhookPublisher
{
    ...
    public WebhookPublisher(IRabbitMqConnection connection, ILogger<WebhookPublisher> logger)
    {
    ...
    public async Task PublishAsync(WebhookMessage message, CancellationToken cancellationToken = default)
    {
        ...
        {
            //RabbitMq erişilemiyor -> Webohooku atla, ödeme akışı devam etsin (fail-open)
            _logger.LogWarning(ex, "Webhook Kuyruğa gönderilemedi, atlanıyor");
        }
    }
}